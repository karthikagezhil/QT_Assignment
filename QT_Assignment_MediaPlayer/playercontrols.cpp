    ...
    : QWidget(parent)
{
    ...
    m_volumeSlider->setToolTip("adjust volume");

    connect(m_volumeSlider, &QSlider::valueChanged, this, &PlayerControls::onVolumeSliderValueChanged);

    m_seekbackButton = new QToolButton(this);
    m_seekbackButton->setIcon(style()->standardIcon(QStyle::SP_MediaSeekBackward));
    m_seekbackButton->setToolTip("seek backward");

    connect(m_seekbackButton, &QAbstractButton::clicked, this, &PlayerControls::seekbackwards);
    ...
    m_rateBox->setToolTip("adjust playback rate, standard set to 1.0x");
    ...
    m_seekforwardButton->setToolTip("seek forward");

    connect(m_seekforwardButton, &QAbstractButton::clicked, this, &PlayerControls::seekforwards);
    ...
    layout->addWidget(m_seekbackButton);
